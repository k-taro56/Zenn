---
title: "C 言語 SIMD 入門：2 つの配列の共分散を求める"
emoji: "🐡"
...
この記事では C 言語で SIMD の一つである x64（amd64、x86-64）の AVX2 を使用して、2 つの配列の共分散を求める方法を紹介します。
...
https://github.com/k-taro56/ZennSimdSample/tree/main/ArrayCovariance
